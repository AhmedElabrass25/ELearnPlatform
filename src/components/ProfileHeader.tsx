        ...
        <div className="relative mb-8">
            ...
            <div className="px-6 sm:px-10 pb-6 flex flex-col justify-center items-center gap-6 -mt-16 sm:-mt-20 relative z-10">
                <div className="relative inline-block self-start sm:self-auto">
                    <div className="w-32 h-32 capitalize sm:w-40 sm:h-40 rounded-full border-4 border-background bg-muted flex items-center justify-center text-4xl font-bold text-muted-foreground shadow-xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-300 dark:from-gray-800 dark:to-gray-900">
                        {initials}
                    </div>
                </div>
