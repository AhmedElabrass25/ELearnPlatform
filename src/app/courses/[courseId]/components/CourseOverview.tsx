...
export function CourseOverview({ course }: CourseOverviewProps) {
    const learningPoints = [
        "تغطية كاملة وشاملة لمنهج النحو المصري",
        "أسلوب شرح مبسط يناسب كافة المستويات",
        "أكثر من 500 سؤال للتدريب على نمط الامتحان",
        ...
        <div className="space-y-12 mt-0">
            ...
            <div className="space-y-6 text-right">
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground leading-relaxed">
                    ...
                    <p>
                        هذا الكورس مصمم خصيصاً لطلاب الصف الثالث الثانوي والمهتمين بالتعمق في قواعد اللغة العربية. 
